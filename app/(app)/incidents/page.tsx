...
export default function IncidentsPage() {
  ...
  return (
    <div className="space-y-6">
          ...
          {filteredIncidents.length > 0 ? (
                  ...
                  {filteredIncidents.map((incident) => (
                    <tr key={incident.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                          <User className="h-4 w-4 mr-2 text-gray-500" />
                          <span className="text-gray-700">{incident.assignedTo}</span>
                        </div>
                      </td>
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <Button variant="destructive" size="sm" onClick={() => handleDeleteIncident(incident)}>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                {searchQuery ? 'Try adjusting your search terms.' : 'Great! No incidents to report.'}
              </p>
              {!searchQuery && (
        ...
        >
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <Badge 
                variant={
                  ...
                  selectedIncident.status === 'investigating' ? 'default' : 
                  'destructive'
                }
              >
            ...
            <div>
              ...
              <p className="text-gray-600 capitalize">{selectedIncident.priority}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">{selectedIncident.assignedTo}</p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900">Reported At</h3>
              <p className="text-gray-600">{formatDate(selectedIncident.reportedAt)}</p>
            </div>
            <div>
      ...
      {isDeleteDialogOpen && selectedIncident && (
        <ConfirmDialog
