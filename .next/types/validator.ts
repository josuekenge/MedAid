...
// Validate ../../app/api/nurses/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/nurses">> = Specific
  const handler = {} as typeof import("../../app/api/nurses/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
