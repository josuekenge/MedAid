...
const useThemeStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        resolvedTheme: 'light',
        setResolvedTheme: (resolvedTheme)=>set({
                resolvedTheme
            })
    }), {
    name: 'medaid-theme',
...
function ThemeProvider(param) {
    let { children, attribute = 'class', defaultTheme = 'system', enableSystem = true, disableTransitionOnChange = false } = param;
    _s();
    const { theme, setTheme, resolvedTheme, setResolvedTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$theme$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThemeStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            if (disableTransitionOnChange) {
                ...
                return ({
                    "ThemeProvider.useEffect": ()=>clearTimeout(timeout)
                })["ThemeProvider.useEffect"];
            }
        }
    }["ThemeProvider.useEffect"], [
...
_s(ThemeProvider, "XbirRQYVJDH9ATDRNXjaeMbK2Yw=", false, function() {
    return [
...
_s(QueryProvider, "M/UcRy/sW6s2ZfGWosiBEMX9k+0=");
_c = QueryProvider;
var _c;
...
function formatCurrency(amount) {
    let currency = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'CAD';
...
_s(ToastProvider, "6x/TP0deODulQzMzhmZDezKlVLk=");
_c = ToastProvider;
function useToast() {
    _s1();
...
function ToastItem(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('max-w-sm w-full shadow-lg rounded-2xl border p-4 transition-all duration-300 ease-in-out', 'transform translate-x-0 opacity-100', getBackgroundColor()),
...
const toast = {
    ...
    }, "ubwSGUJGTwpn9cIwx73/Ga/BuiI=", false, function() {
        return [
            useToast
        ];
    }),
    error: _s3((title, description)=>{
        _s3();
        const { addToast } = useToast();
        addToast({
            type: 'error',
...
function Analytics() {
    _s();
    const gaId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_GA4_ID;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Analytics.useEffect": ()=>{
...
const trackPageView = (url, title)=>{
    if ("object" !== 'undefined' && window.gtag) {
        window.gtag('config', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_GA4_ID, {
            page_title: title,
            page_location: url
        });
    }
...
//# sourceMappingURL=_712005d3._.js.map