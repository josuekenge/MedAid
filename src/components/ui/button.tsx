  ...
  ({ className, variant = 'default', size = 'default', asChild = false, ...props }, ref) => {
    ...
    switch (variant) {
      ...
      case 'outline':
        ...
        break;
      case 'ghost':
        buttonClassName += ' !text-primary-700 hover:!bg-primary-100 active:!bg-primary-200';
        break;
      case 'destructive':
        buttonClassName += ' bg-red-600 text-white hover:bg-red-700 hover:shadow-md active:bg-red-800 active:scale-95';
        break;
      case 'link':
        buttonClassName += ' text-primary-600 underline-offset-4 hover:underline active:text-primary-800';
        break;
      case 'primary':
    ...
    switch (size) {
      case 'sm':
        ...
        break;
      case 'lg':
        buttonClassName += ' h-12 px-8 text-base';
        break;
      case 'icon':
