...
export default function ServicesPage() {
  ...
  const handleDeleteService = (service: any) => {
    router.push(`/services/${service.id}/delete`);
  };
  ...
  return (
    <div className="space-y-6">
                ...
                <tbody>
                  {filteredServices.map((service) => (
                    <tr key={service.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        <span className="text-gray-700 capitalize">{service.category}</span>
                      </td>
                      <td className="py-3 px-4">
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{getStatusText(selectedService.status)}</p>
              </div>
              <div>
                <h3 className="font-medium text-gray-900">Created At</h3>
                <p className="text-gray-600">{selectedService.createdAt ? new Date(selectedService.createdAt).toLocaleDateString() : 'Unknown'}</p>
              </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button variant="primary" onClick={() => handleEditService(selectedService)}>
                Edit Service
              </Button>
            </div>
          </div>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          alert(`Deleting service ${selectedService?.id} (mock action)`);
