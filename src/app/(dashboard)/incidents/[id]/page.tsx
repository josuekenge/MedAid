...
export default function IncidentViewPage() {
  ...
  const handleEdit = () => {
    router.push(`/incidents/${params.id}/edit`);
  };

  const handleDelete = () => {
    router.push(`/incidents/${params.id}/delete`);
  };
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600">The incident you're looking for doesn't exist or has been removed.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">View and manage incident information</p>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700">{formatDate(incident.updatedAt)}</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-500 mb-1">Actions Taken</h4>
              <p className="text-gray-700">{incident.actionsTaken || 'No actions recorded'}</p>
            </div>
            <div>
              <h4 className="text-sm font-medium text-gray-500 mb-1">Resolution Notes</h4>
              <p className="text-gray-700">{incident.resolutionNotes || 'No resolution notes'}</p>
            </div>
          </div>
        </CardContent>
      </Card>
